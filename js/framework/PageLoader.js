import * as Events from "./EventMaster.js"
...
export class PageLoader{   
     ...
     * @param {string} page_container_id The id of the container you want all pages to load into
     ...
     * @constructor
     * */
    constructor( default_page_name, page_container_id, args={}){
    ...
    // Prepare the page
        ...
        this.page_container = document.getElementById( page_container_id )
    ...
    // Animate divs
        ...
        let new_div = document.createElement('div')            
            ...
            this.page_container.append( new_div )
